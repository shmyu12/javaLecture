...
public class Lect03Controller {
    ...
    @RequestMapping("/money_input")
    public String moneyInput() {
        return "lect03/money_input";
    }

    @RequestMapping("/tax_output")
    public String taxOutput(@RequestParam("money") String excludeTax, ModelMap modelMap) {
        int money = Integer.parseInt(excludeTax);
        int tax = (int)((double)money * 0.08);
        modelMap.addAttribute("tax", tax);
        return "lect03/tax_output";
    }
}
